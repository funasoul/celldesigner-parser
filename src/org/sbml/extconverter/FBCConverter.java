...
public class FBCConverter extends EXTConverter {
   ...
   */
  public LogicalOperator setAllProductRef(LogicalOperator lo,
    String[] modifiers, String reactionId) {
    for (String modifier : modifiers) {
      GeneProductRef gpr = lo.createGeneProductRef("GeneProductRef_"
        + reactionId + "_" + modifier);
