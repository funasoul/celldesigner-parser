...
public class LayoutConverter {
  ...
  public LayoutConverter(File file) throws JAXBException, XMLStreamException,
    IOException {
    this(file, false, SBMLUtil.isSetCellDesignerNameSpace(file),
  ...
  public LayoutConverter(File file, boolean defaultCompartment,
    boolean isCD2Layout) throws JAXBException, XMLStreamException, IOException {
    if (isCD2Layout)
   ...
   */
  public LayoutConverter(File file, boolean defaultCompartment,
    boolean isCD2Layout, String outputFileName) throws JAXBException,
   ...
   *         Signals that an I/O exception has occurred.
   */
  public LayoutConverter(File file, String outputFileName)
  ...
  public LayoutConverter(File file, Boolean defaultCompartment)
    throws JAXBException, XMLStreamException, IOException {
    this(file, defaultCompartment, SBMLUtil.isSetCellDesignerNameSpace(file),
      SBMLUtil.createOutputFileName(file));
  }
   ...
   */
  public LayoutConverter(File file, Boolean defaultCompartment,
    String outputpath) throws JAXBException, XMLStreamException, IOException {
    this(file, defaultCompartment, SBMLUtil.isSetCellDesignerNameSpace(file),
      outputpath);
  }
   ...
   *         the JAXB exception
   */
  public LayoutConverter(File file, ApplicationOption options)
