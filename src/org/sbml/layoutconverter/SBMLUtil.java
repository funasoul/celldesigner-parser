...
public class SBMLUtil {
  ...
  public static final int intSBOTermForHETERODIMER_ASSOCIATION    = 177;                                       // non-covalent
                                                                                                                // binding
   ...
   */
  public static boolean isSetCellDesignerNameSpace(File file)
  ...
  public static SBMLDocument addExtensionPackageLayout(SBMLDocument document) {
    document.enablePackage(LayoutConstants.getNamespaceURI(
      SBMLUtil.DEFAULT_SBML_LEVEL, SBMLUtil.DEFAULT_SBML_VERSION), true);
    document.setPackageRequired(LayoutConstants.getNamespaceURI(
      SBMLUtil.DEFAULT_SBML_LEVEL, SBMLUtil.DEFAULT_SBML_VERSION), true);
    return document;
  }
  ...
  public static SBMLDocument addExtensionPackageFBC(SBMLDocument document) {
    document.enablePackage(FBCConstants.getNamespaceURI(
      SBMLUtil.DEFAULT_SBML_LEVEL, SBMLUtil.DEFAULT_SBML_VERSION), true);
    document.setPackageRequired(FBCConstants.getNamespaceURI(
      SBMLUtil.DEFAULT_SBML_LEVEL, SBMLUtil.DEFAULT_SBML_VERSION), false);
    return document;
  }
   ...
   *         Signals that an I/O exception has occurred.
   */
  public static boolean isLevelAndVersionMatchWithCD(File file)
    throws XMLStreamException, IOException {
  ...
  public static boolean isLevelAndVersionMatchWithCD(SBMLDocument document) {
    return (document.getLevel() == DEFAULT_CELLDESIGNER_SBML_LEVEL)
      && (document.getVersion() == DEFAULT_CELLDESIGNER_SBML_VERSION);
  }
  ...
  public static boolean isSetSBOTerm(SBMLDocument document) {
    boolean species = checkSBOTermFromList(document.getModel()
                                                   .getListOfSpecies());
    boolean compartment = checkSBOTermFromList(document.getModel()
                                                       .getListOfCompartments());
    boolean reaction = checkSBOTermFromList(document.getModel()
                                                    .getListOfReactions());
    ...
    return species && compartment && reaction && reactant && product
      && modifier;
  }
  ...
  public static void addDefaultSBOTerm(TreeNode node) {
    ...
    if (sbase instanceof Model) {
      ...
      Reaction r = (Reaction) ((SpeciesReference) sbase).getParentSBMLObject()
                                                        .getParentSBMLObject();
   ...
   */
  public static boolean containsReferencingSpecies(
    ListOf<SpeciesReference> list, String id) {
  ...
  public static String SBOTermToString(int sboTerm) {
    ...
    case intSBOTermForCATALYSIS: // = intSBOTermForUNKNOWN_CATALYSIS
      return "CATALYSIS";
    case intSBOTermForINHIBITION: // = intSBOTermForTRANSLATIONAL_INHIBITION =
                                  // intSBOTermForTRANSCRIPTIONAL_INHIBITION =
                                  // intSBOTermForUNKNOWN_INHIBITION
      return "INHIBITION";
    case intSBOTermForPHYSICAL_STIMULATION:
      return "PHYSICAL_STIMULATION";
    case intSBOTermForTRANSCRIPTIONAL_ACTIVATION: // =
  ...
  public static void setMathObject(SBMLDocument d, AbstractMathContainer math) {
    if (math instanceof FunctionDefinition) {
      ...
      d.getModel().getReaction(kl.getParent().getId())
       .setKineticLaw((KineticLaw) math.clone());
    } else if (math instanceof EventAssignment) {
      EventAssignment ea = (EventAssignment) math;
      Event e = (Event) ea.getParentSBMLObject();
      d.getModel().getEvent(e.getId()).getListOfEventAssignments()
       .append((EventAssignment) math.clone());
