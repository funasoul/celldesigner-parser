...
public class ComplexSpeciesAliasWrapper extends ComplexSpeciesAlias {
   ...
   *        the model wrapper
   */
  public ComplexSpeciesAliasWrapper(ComplexSpeciesAlias complexSpeciesAlias,
  ...
  /**
   * @param compartmentAliasWrapper
   *        the compartmentAliasWrapper to set
   */
