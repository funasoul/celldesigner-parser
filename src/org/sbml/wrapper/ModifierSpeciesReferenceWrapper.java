...
public class ModifierSpeciesReferenceWrapper extends ModifierSpeciesReference {
   ...
   *        the reaction wrapper
   */
  public ModifierSpeciesReferenceWrapper(ModifierSpeciesReference sRef,
    ModelWrapper modelWrapper, ReactionWrapper reactionWrapper) {
    this.sRef = sRef;
