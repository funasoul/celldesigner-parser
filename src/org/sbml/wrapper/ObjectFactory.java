...
public class ObjectFactory {
   ...
   *         the JAXB exception
   */
  public static ModelWrapper unmarshalSBMLFromString(String xml)
    throws JAXBException {
    sbml = getSbml(xml);
    model = sbml.getModel();
    modelWrapper = createModelWrapper(model, sbml);
   ...
   *         the JAXB exception
   */
  public static File saveModel(ModelWrapper modelWrapper, String fileName)
    throws JAXBException {
   ...
   *         the JAXB exception
   */
  public static String generateXMLString(ModelWrapper modelWrapper)
    throws JAXBException {
