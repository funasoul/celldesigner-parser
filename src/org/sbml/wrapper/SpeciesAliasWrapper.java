...
public class SpeciesAliasWrapper extends SpeciesAlias {
   ...
   *        the model wrapper
   */
  public SpeciesAliasWrapper(SpeciesAlias speciesAlias,
   ...
   *
   * @param id
   *        the new compartment alias wrapper
   */
   ...
   * (non-Javadoc)
   * @see
   * org.sbml._2001.ns.celldesigner.SpeciesAlias#setCompartmentAlias(java.lang
   * .String)
   */
